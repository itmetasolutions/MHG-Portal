...
export function buildNumberSearchedTemplate(input: NumberSearchedTemplateInput): {
  ...
  const subject = "Your landlord number was searched — More Homes Group";
        ...
        <table width="560" cellpadding="0" cellspacing="0" style="background:#111118;border-radius:10px;overflow:hidden;border:1px solid #2a2a3a;">
          <tr>
            <td style="background:#c9a84c;padding:18px 32px;">
              <span style="font-size:18px;font-weight:700;color:#080810;letter-spacing:0.5px;">More Homes Group Portal</span>
            </td>
          </tr>
          <tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background:#1a1a24;border-radius:8px;border:1px solid #2a2a3a;margin-bottom:24px;">
                <tr>
                  <td style="padding:20px 24px;">
                    ...
                    <p style="margin:0 0 16px;font-size:16px;font-weight:600;color:#c9a84c;">${input.searchingAgentName}</p>
          ...
          <tr>
            <td style="padding:16px 32px;border-top:1px solid #2a2a3a;">
              <p style="margin:0;font-size:12px;color:#8a7e68;text-align:center;">More Homes Group Portal — Automated Notification</p>
            </td>
          </tr>
        </table>
      </td>
